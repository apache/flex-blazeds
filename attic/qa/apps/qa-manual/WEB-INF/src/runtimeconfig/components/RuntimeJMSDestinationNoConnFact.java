...
/* 
 * The purpose of this class is create a JMS destination without a connection factory.
...
public class RuntimeJMSDestinationNoConnFact extends AbstractBootstrapService
{
    ...
    /*
     * The following static properties are implemented below for the 
     * JMSDestNoConnFact_startup and runtime destinations.
     * 
        <properties>
            <network>
